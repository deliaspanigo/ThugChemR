...
Plot_PackTC_04_Oxyde01 <- function(chem_symbol,
  ...
  for(k in 1:nrow(selected_resolution)){
    ...
    graphics::text(x = 2,
                   y = nrow(selected_resolution) - (k*1) + 2,
...
Plot_PackTC_04_Oxyde02 <- function(chem_symbol,
  ...
  graphics::text(3, 8, chem_formula, pos = 4, cex = 2)

  graphics::text(3, 5, nomenclatura[1], pos = 4, cex = 2)
  graphics::text(3, 3, nomenclatura[2], pos = 4, cex = 2)
  graphics::text(3, 1, nomenclatura[3], pos = 4, cex = 2)
